...
final class SwiftNetCDFTests: XCTestCase {
    ...
    func testCreateGroups() throws {
        ...
        func printGroup(_ group: Group) throws {
    ...
    func testGroups() throws {
        ...
        _ = try file.createVariable(name: "TEST_VAR", type: Int32.self, dimensions: [dim])
        ...
        _ = try group1_1.createVariable(name: "TEST_VAR", type: Int32.self, dimensions: [dim])
        XCTAssertNotNil(group1_1.getVariable(name: "TEST_VAR"))
    }

    /// TODO unit test for subgroups.. also check missing
